...
//The original code is credited to the answer of
...
public class Wave
{
    ...
    public Wave(int sampleRate, short nChannels, List<Short> data, int start, int end)
    {
        nSamples=end-start+1;
        cursor=0;
        output=new byte[nSamples*SMALLINT+WAV_HDR_SIZE+2];
    ...
    // ------------------------------------------------------------
    public void writeData(List<Short> data, int start, int end)
    {
        write("data");
